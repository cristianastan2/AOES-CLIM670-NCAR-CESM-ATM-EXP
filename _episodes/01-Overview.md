...
Notice that the website indicates which version of CESM you are using in the upper right corner.  Our version is `CESM 2.1.5`.  Let's scroll until we find the `F` compsets. 
...
>
>> ~~~
>> $ ./create_newcase --case ~/cases/testatmF --res f19_g17 --compset FHIST --project UGMU0049
>> ~~~
>> {: .language-bash}
> 
> 
...
>>
>>> ~~~
>>> $ ./create_newcase --case ~/cases/testatmF --res f19_g17 --compset FHIST --project UGMU0049 --run-unsupported
>>> ~~~
>> {: .language-bash}
> {: .solution}
>
